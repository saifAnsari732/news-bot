          ...
          {filteredNews.map((item, i) => (
            <div key={i} className="bg-black/40 border border-white/10 rounded-xl overflow-hidden hover:bg-black/60 transition-all flex flex-col group hover:border-white/20 hover:-translate-y-1">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <Link href={`/read?url=${encodeURIComponent(item.link)}`} className="inline-flex items-center justify-center gap-2 text-sm font-medium text-black bg-white hover:bg-slate-200 px-4 py-2.5 rounded-lg transition-colors mt-auto">
